...
select
  ...
  date_trunc(parse_timestamp('%FT%T', json_value(message_json, '$.ordered_at')) , day) as day_ordered_on,
  date_trunc(parse_timestamp('%FT%T', json_value(message_json, '$.ordered_at')) , week) as week_ordered_on,
  date_trunc(parse_timestamp('%FT%T', json_value(message_json, '$.ordered_at')) , month) as month_ordered_on,
